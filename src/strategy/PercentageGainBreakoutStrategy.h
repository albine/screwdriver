...
public:
    ...
    void on_start() override {
        LOG_M_INFO("PercentageGainBreakoutStrategy started for {}", symbol);
    }

    void on_stop() override {
        LOG_M_INFO("PercentageGainBreakoutStrategy stopped for {}", symbol);
    }
...
public:
    void on_tick(const MDStockStruct& stock) override {
        ...
        // (No further action in on_tick once detector is armed)
